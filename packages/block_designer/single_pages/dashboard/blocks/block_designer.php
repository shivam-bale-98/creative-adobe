    ...
    <form action="<?php echo $this->action(''); ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div id="horizontalTab" class="hidden d-none">
                        <ul>
                        ...
                        <div id="tab-basics">
                            <div class="form-group">
                                ...
                                <?php echo $form->text('block_handle', isset($post_data, $post_data['block_handle']) ? $post_data['block_handle'] : null, ['placeholder' => 'my_handle','data-validation' => 'custom', 'data-validation-regexp' => '^([a-z]+)([a-z_]+)[a-z]$']); ?>
                            </div>
                        ...
                        <div id="tab-interface">
                            ...
                            <div class="form-group" id="form-group-default_set">
                                ...
                                <?php echo $form->text('default_set', isset($post_data, $post_data['default_set']) ? $post_data['default_set'] : null, ['data-validation-regexp' => '^([a-z]+)([a-z_]+)[a-z]$', 'data-validation' => 'custom', 'data-validation-optional' => 'true']); ?>
                            </div>

                            <div class="form-group" id="form-group-block_type_set">
                                <label for="block_type_set"><?php echo t('Block type set'); ?></label>

                                <?php echo $form->select('block_type_set', $block_type_sets, isset($post_data, $post_data['block_type_set']) ? $post_data['block_type_set'] : null, []); ?>
                            </div>
                        </div>
                        ...
                        <div id="tab-advanced">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $form->select('ignore_page_theme_grid_framework_container', $yesNo, isset($post_data, $post_data['ignore_page_theme_grid_framework_container']) ? $post_data['ignore_page_theme_grid_framework_container'] : null, []); ?>
                            </div>

                            <div class="form-group">
                                <label for="cache_block_record" class="control-label"><?php echo t('Cache block record'); ?></label>

                                <?php echo $form->select('cache_block_record', $yesNo, isset($post_data, $post_data['cache_block_record']) ? $post_data['cache_block_record'] : null, []); ?>
                            </div>

                            <div class="form-group">
                                <label for="cache_block_output" class="control-label"><?php echo t('Cache block output'); ?></label>

                                <?php echo $form->select('cache_block_output', $yesNo, isset($post_data, $post_data['cache_block_output']) ? $post_data['cache_block_output'] : null, []); ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $form->select('cache_block_output_on_post', $yesNo, isset($post_data, $post_data['cache_block_output_on_post']) ? $post_data['cache_block_output_on_post'] : null, []); ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $form->select('cache_block_output_for_registered_users', $yesNo, isset($post_data, $post_data['cache_block_output_for_registered_users']) ? $post_data['cache_block_output_for_registered_users'] : null, []); ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $form->text('cache_block_output_lifetime', isset($post_data, $post_data['cache_block_output_lifetime']) ? $post_data['cache_block_output_lifetime'] : null, ['data-validation' => 'number', 'data-validation-allowing' => 'range[0;999999]', 'data-validation-optional' => 'true']); ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $form->text('table_prefix', isset($post_data, $post_data['table_prefix']) ? $post_data['table_prefix'] : null, ['data-validation-optional' => 'true', 'data-validation' => 'custom', 'data-validation-regexp' => '^[a-zA-Z]{2,15}$']); ?>
                            </div>
                        </div>
                        ...
                        <div id="tab-assets">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $form->textarea('view_css', isset($post_data, $post_data['view_css']) ? $post_data['view_css'] : null, ['data-validation' => '', 'rows' => 3]); ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $form->textarea('view_js', isset($post_data, $post_data['view_js']) ? $post_data['view_js'] : null, ['data-validation' => '', 'rows' => 3]); ?>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <script id="contentField" type="text/x-handlebars-template">
                        <div class="content-field" data-id="{{id}}" data-type="{{type}}">
                            ...
                            <div class="header">
                                ...
                                <span>{{{type_name}}} (<?php echo t('Row'); ?>: #{{id}})<span class="label label-primary{{#if label }}{{ else }} hidden d-none{{/if}}">{{label}}</span></span>
                    ...
                    <div class="content-fields-links hidden d-none">
                        ...
                        if (!empty($field_types)) {
                            ...
                            <ul class="field-types">
                                ...
                                foreach ($field_types as $key => $value) {
                                    ...
                                    echo '<li' . (is_array($ft_hide) && in_array($key, $ft_hide) ? ' class="hidden d-none"' : null) . '><a href="#" data-use-base-fields="' . var_export($useBaseFields, true) . '" data-use-can-repeat="' . var_export($canRepeat, true) . '" data-type="' . $key . '" ' . $title . '><span class="icon"><img src="' . $value['icon'] . '" alt="icon" /></span>' . $value['name'] . '</a>' . $note . '</li>';
                                } ?>
                            </ul>
                            <?php
                        } else {
            ...
            <div class="row">
                <div class="col-xs-12">
                    <button class="make-block btn btn-primary btn-lg" disabled="disabled">
