                ...
                <div class="col-md-6 side-xs-xs side-sm-xs">
                    <div class="form-group">
                        <label for="fieldLabels[{{id}}][description]" class="control-label">
                            ...
                            <small><?php echo t("Test the example"); ?>: <i class="fa fa-question-circle launch-tooltip" data-bs-toggle="tooltip" data-bs-original-title="<?php echo t("The entered description will be shown with the very same question mark, next to the entered label. Users have to hover the question mark to show the description."); ?>"></i></small>
                        </label>
