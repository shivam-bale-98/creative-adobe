...
* Fixed non-working "WYSIWYG" field type used in none "Repeatable" field types from Block Designer Pro in combination with PHP 8;

#v4.1.2

* Global fix for field types not using a label (like "Static" field type);
* Additional fixes for strict(er) PHP version 8 - tested in PHP 8.2;
