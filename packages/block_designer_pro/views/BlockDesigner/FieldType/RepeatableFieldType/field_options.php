    ...
    <div class="form-group-fake">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="fields[{{id}}][collapse_on_load]" class="control-label">
                        <input type="checkbox" name="fields[{{id}}][collapse_on_load]" value="1" id="fields[{{id}}][collapse_on_load]" {{#xif " this.collapse_on_load == '1' " }}checked="checked"{{/xif}}>
                        <?php echo t('Collapse all items on first time loading'); ?>
                        <br/>
                        <small><?php echo t('This will make the list of all items very small and easy to sort/order'); ?></small>
                    </label>
                </div>
