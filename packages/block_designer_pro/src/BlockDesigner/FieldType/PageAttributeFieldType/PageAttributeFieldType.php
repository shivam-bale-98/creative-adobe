<?php namespace Concrete\Package\BlockDesignerPro\Src\BlockDesigner\FieldType\PageAttributeFieldType;
...
class PageAttributeFieldType extends FieldType
{
    ...
    {
        return parent::view('field_options.php', ['pageAttributes' => $this->getPageAttributes()]);
    }
