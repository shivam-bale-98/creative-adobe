<?php namespace Concrete\Package\BlockDesignerPro\Src\BlockDesigner\FieldType\FileSetFieldType;
...
if (count($' . $slugFileListFiles . ') > 0) {
	...
	{
		return parent::view('field_options.php', ['titleWrapperOptions' => $this->getTitleWrapperOptions()]);
	}
