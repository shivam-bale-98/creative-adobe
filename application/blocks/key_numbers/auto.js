Concrete.event.bind('btKeyNumbers.keyNumbersLeft.edit.open', function (options, settings) {
...
});Concrete.event.bind('btKeyNumbers.keyNumbersRight.edit.open', function (options, settings) {
    var container = $('#' + settings.id);
    var hbTemplate = Handlebars.compile($(container).find('.repeatableTemplate').html());
    var sortableItems = $(container).find('.sortable-items');
    var slideSpeed = 200;
