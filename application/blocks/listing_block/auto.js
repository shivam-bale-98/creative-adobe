Concrete.event.bind('btListingBlock.button.open', function (options, settings) {
...
Concrete.event.bind('btListingBlock.filters.edit.open', function (options, settings) {
    //register helpers
    Handlebars.registerHelper('isMultiple', (value) => {
        return !!value
    });
    ...
    $(document).ready(function () {
        ...
        if ($.isPlainObject(data)) {
            ...
            loadComplete();
            $(sortableItems).find('.sortable-item').addClass('collapsed');
...
Concrete.event.bind('listing_block.pageTypes.multiple_select', function () {
    $(document).ready(function () {
        $('.ft-multipleSelect-listing_block-pageTypes').select2();
    });
});
Concrete.event.bind('listing_block.sortOptions.multiple_select', function () {
    $(document).ready(function () {
        $('.ft-multipleSelect-listing_block-sortOptions').select2();
    });
});