...
<div class="form-group">
    <?php echo $form->label($view->field('selectForm'), t("select Form")); ?>
    <?php echo isset($btFieldsRequired) && in_array('selectForm', $btFieldsRequired) ? '<small class="required">' . t('Required') . '</small>' : null; ?>
    <?php echo $form->selectMultiple($view->field('selectForm'), $selectForm_options, isset($selectForm_selected) ? $selectForm_selected : [], []); ?>
</div>

<script type="text/javascript">
    Concrete.event.publish('talk_to_us.selectForm.stacks');
</script>
