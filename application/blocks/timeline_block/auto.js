Concrete.event.bind('btTimelineBlock.addTimeline.edit.open', function (options, settings) {
    ...
    var ftImageImage = $(newField).find('.ft-image-addTimeline-image-file-selector');
            ...
            var pageSelectorImage = $(newField).find('.ft-image-addTimeline-image-page-selector');
