...
<div class="formidable fade-text" data-duration="1.2" data-delay="0.5" id="formidable_<?= $bID; ?>">
    ...
    <?php } else { ?>
        ...
        <div id="formidable_<?= $ff->getHandle(); ?>" class="position-relative <?= isset($options['formAdditionalClass']) ? $options['formAdditionalClass'] : ''; ?>">
            ...
            <h4 class="loader-spinner absolute">please wait</h4>
        </div>
