...
<?php $repeatable_container_id = 'btTechnologyCardSlider-addCards-container-' . $identifier_getString; ?>
...
<script type="text/javascript">
    Concrete.event.publish('btTechnologyCardSlider.addCards.edit.open', {id: '<?php echo $repeatable_container_id; ?>'});
