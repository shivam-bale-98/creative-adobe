...
<section <?php if (isset($bgColor) && trim($bgColor) != "") { ?>style="background-color: <?php echo h($bgColor); ?>;" <?php } ?> class="<?php if (isset($hideBlock) && trim($hideBlock) == 1) { ?>hide-block<?php } ?> <?php if (isset($removePaddingTop) && trim($removePaddingTop) == 1) { ?>pt-0<?php } ?> <?php if (isset($removePaddingBottom) && trim($removePaddingBottom) == 1) { ?>pb-0<?php } ?> techologies-slider relative xxl:px-[10rem] xl:px-[6rem] md:px-[4rem] px-[2rem] xl:pb-[10rem] md:pb-[8rem] pb-[5rem] text-rustic-red">
            ...
            <div class="swiper-wrapper">
                <?php foreach ($addCards_items as $addCards_item_key => $addCards_item) { ?>
                    <div class="swiper-slide">
                        <div class="technology-card  overflow-hidden">
