...
use Application\Concrete\Models\CaseStudies\CaseStudies;
?>
...
<section style="background-color: #F2F1EF;" class="case-studies-listing xxl:px-[10rem]  xl:px-[6rem] md:px-[4rem] px-[2rem] xl:pt-[10rem] xl:pb-[0rem] xl:mb-[-15rem]  md:py-[8rem] py-[5rem] text-rustic-red">
  ...
  <div class="title flex flex-wrap items-center justify-between">
    ...
    <div class="right flex md:justify-end items-center xl:w-1/4 md:w-1/2 w-full mt-[2rem] md:mt-[0rem] fade-text" data-duration="1" data-delay="0.2">
      <?php if (trim($link_URL) != "") { ?>
        ...
        echo sprintf('<a tabindex="0" role="link" aria-label="view more ' . t($title) . '" class="channeline-btn channeline-btn--arrow channeline-btn--border channeline-btn--red relative" %s>
