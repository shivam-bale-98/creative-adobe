...
<div class="form-group">
    ...
    <?php echo Core::make("helper/concrete/asset_library")->image('ccm-b-address_block-Image-' . $identifier_getString, $view->field('Image'), t("Choose Image"), isset($Image_o) ? $Image_o : null); ?>
</div>
