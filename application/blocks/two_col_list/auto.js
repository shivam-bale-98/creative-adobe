Concrete.event.bind('btTwoColList.list.edit.open', function (options, settings) {
    ...
    var updateItem = function (newField) {
        ...
        $.each($(newField).find('.ft-smart-link'), function () {
            var ftSmartLinkImage = $(this).find('.ft-smart-link-list-link-image-selector');
            ...
            var ftSmartLinkFile = $(this).find('.ft-smart-link-list-link-file-selector');
            ...
            var ftSmartLinkPage = $(this).find('.ft-smart-link-list-link-page-selector');
    ...
    var ftImageImage = $(newField).find('.ft-image-list-image-file-selector');
            ...
            var pageSelectorImage = $(newField).find('.ft-image-list-image-page-selector');
