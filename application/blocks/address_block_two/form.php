...
<div class="form-group">
    ...
    <?php echo Core::make("helper/concrete/asset_library")->image('ccm-b-address_block_two-Image-' . $identifier_getString, $view->field('Image'), t("Choose Image"), isset($Image_o) ? $Image_o : null); ?>
</div>
...
<div class="form-group">
    <?php echo $form->label($view->field('description_1'), t("desc")); ?>
    <?php echo isset($btFieldsRequired) && in_array('description_1', $btFieldsRequired) ? '<small class="required">' . t('Required') . '</small>' : null; ?>
    <?php echo $form->textarea($view->field('description_1'), isset($description_1) ? $description_1 : null, array (
  'rows' => 5,
)); ?>
</div>

<div class="form-group">
    <?php echo $form->label($view->field('phNumber'), t("phone number")); ?>
    <?php echo isset($btFieldsRequired) && in_array('phNumber', $btFieldsRequired) ? '<small class="required">' . t('Required') . '</small>' : null; ?>
    <?php echo $form->text($view->field('phNumber'), isset($phNumber) ? $phNumber : null, array (
  'maxlength' => 255,
)); ?>
</div>
...
<div class="form-group">
    ...
    <?php echo $form->text($view->field('eMail'), isset($eMail) ? $eMail : null, array (
  'maxlength' => 255,
)); ?>
</div>
