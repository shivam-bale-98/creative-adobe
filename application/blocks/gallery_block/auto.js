Concrete.event.bind('btGalleryBlock.gallery.edit.open', function (options, settings) {
    ...
    var ftImageImage = $(newField).find('.ft-image-gallery-image-file-selector');
            ...
            var pageSelectorImage = $(newField).find('.ft-image-gallery-image-page-selector');
