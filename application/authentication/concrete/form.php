...
<form id="login_form" method="post" action="<?= URL::to('/login', 'authenticate', $this->getAuthenticationTypeHandle()) ?>">
    ...
    <div class="form-group">
        <button class="btn btn-primary g-recaptcha"
                data-sitekey="<?php echo $config->get('captcha.recaptcha_v3.site_key'); ?>"
                data-callback='onSubmit'
                data-action='submit' id="login_button" name="login_button" ><?= t('Log in') ?></button>
